...
*/ 
const Carlinhos= new Precidente("carlinhso da silva","monster Hai", "federal","executivo", "sua mainha tu tu ta uat","brasilia",1,["projeto sua mae", "a"],["Emmanuelle", "rogerio", "Havanna"]);
